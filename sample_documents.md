# Sample Documents for NAT_ANG

Ces documents sont des exemples à insérer manuellement dans la base de données pour tester l'application.

## Document 1: Logistics - Warehouse Safety Procedures

**Titre:** Warehouse Safety Procedures
**Catégorie:** logistique
**Contenu:**

Warehouse safety is a critical aspect of logistics operations that requires constant attention and adherence to established protocols. Every worker must understand and follow basic safety guidelines to prevent accidents and ensure a secure working environment.
...
## Document 2: Transport - Commercial Driver's Log Requirements

**Titre:** Understanding Hours of Service Regulations for Truck Drivers
**Catégorie:** transport
**Contenu:**

Commercial truck drivers must comply with Hours of Service regulations designed to prevent fatigue-related accidents and ensure road safety. These federal regulations establish strict limits on driving time and require mandatory rest periods.
...
## Document 3: Mechanics - Basic Engine Troubleshooting

**Titre:** Diesel Engine Starting Problems: A Diagnostic Guide
**Catégorie:** mecanique
**Contenu:**

Diagnosing diesel engine starting problems requires a systematic approach to identify the root cause efficiently. Understanding the basic systems involved in engine operation helps mechanics troubleshoot issues methodically rather than randomly replacing components.
